...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li>   <form name="so" method="post" action="Defect_Tracking">  <input type="submit" name="submit" value="Get Assigned Projects" class="btn btn-danger navbar-btn"/> </form>            </li>
      
      <li>  <form name="so" method="post" action="Defect_Tracking">  <input type="submit" name="submit" value="Register New Defects" class="btn btn-danger navbar-btn"/> </form>    </li>
